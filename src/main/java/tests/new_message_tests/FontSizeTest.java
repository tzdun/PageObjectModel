...
import tests_property_managers.new_message_property_managers.FontSizePropertyManager;
...
public class FontSizeTest extends BaseTest {
    private static class TestData {
        ...
        private static FontSizePropertyManager fontSizePM = new FontSizePropertyManager();
