...
import tests_property_managers.new_message_property_managers.FontStylePropertyManager;

public class FontStyleTest extends BaseTest {
    private static class TestData {
        ...
        private static FontStylePropertyManager fontStylePM = new FontStylePropertyManager();
    ...
    public void fontStyle() {
        ...
        homePage.goToHomePage()
                ...
                .fontColorAndStyleAssertion(TestData.fontStyleAssert)
                .keyPress_Ctrl_A()
                .clickFontStyleAndSizeButton()
                .clickGeorgiaFontStyle()
